...
<body>
    ...
    <div id="container">
        ...
        <header>
            ...
            <span id="score" title="Набранные очки">1234</span>
        </header>
        ...
        <div id="options-page">
            ...
            <form>
                ...
                <input type="button" id="ok" value="oк" />
        ...
        <div id="scores-page">
            ...
            <table>
                <thead>
                    <tr><th>Место</th><th>Игрок</th><th>Очки</th><th>Дата</th></tr>
                </thead>
                <tbody>
        ...
        <footer>
            <a id="logo" href="http://semyonfilippov.net/gallery/2d-works/2010/"><span class="tooltip">Страница в галерее</span></a>
